...
class AddDishWindow:
    ...
    def add_ingredient_row(self):
        ...
        new_combo = QtWidgets.QComboBox()
        new_combo.setObjectName(f"ingredientComboBox{self.ingr_layout_counter}")
        ...
        new_spin = QtWidgets.QSpinBox()
        new_spin.setObjectName(f"countIngredientsSpinBox{self.ingr_layout_counter}")
    ...
    def action_add_dish(self):
        ...
        try:
            ...
            self.db.add_dish_ingredients(dish_id, ingredients)
